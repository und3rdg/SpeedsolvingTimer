...
if(isset($_GET['time_ms']) && !empty($_GET['time_ms'])){ 
    ...
    /* $time_date = $_GET['date']; */
        $sql = "INSERT INTO $table ($tbl_time, $tbl_date) VALUES ($time_ms, $time_date)";
...
if(isset($_GET['plus2']) && !empty($_GET['plus2'])){
    ...
    $sql = "UPDATE $table SET $tbl_plus2=1 where $tbl_time_id=$del_record";
...
if(isset($_GET['dnf']) && !empty($_GET['dnf'])){
    ...
    $sql = "UPDATE $table SET $tbl_dnf=1 where $tbl_time_id=$del_record";
...
if(isset($_GET['del']) && !empty($_GET['del'])){
    ...
    $sql = "UPDATE $table SET $tbl_del=1 where $tbl_time_id=$del_record";
