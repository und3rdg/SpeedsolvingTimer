...
String.prototype.convTime=function(){var t=this%1e3,i=Math.floor(this/1e3),e=Math.floor(i/3600),s=Math.floor((i-3600*e)/60),r=i-3600*e-60*s;return e<10&&(hOut="0"+e+":"),e>=10&&(hOut=e+":"),e<1&&(hOut=""),s<10&&(mOut="0"+s+":"),s>=10&&(mOut=s+":"),s<1&&(mOut=""),r<10&&(sOut="0"+r+"."),r>=10&&(sOut=r+"."),t<100&&(t="0"+t),t<10&&(t="0"+t),hOut+mOut+sOut+t},window.addEventListener("keydown",function(t){32==t.keyCode&&t.target==document.body&&t.preventDefault()});var Timer={iddle:function(){$("html").scrollTop("0"),$("time").css("color","black"),debug.log("stop time // trigerStatus = "+this.trigerStatus)},ready:function(){$("html").scrollTop("0"),$("time").css("color","lightgreen"),debug.log("Ready to start // trigerStatus = "+this.trigerStatus)},runing:function(){$("html").scrollTop("0"),this.timeDate[0]=new Date,$("time").css("color","blue"),this.runTime(),debug.log("start time // trigerStatus = "+this.trigerStatus)},timeDate:[],timeMs:{},runTime:function(){if("stop"==this.trigerStatus&&(clearTimeout(t),debug.log("stop time // trigerStatus = "+this.trigerStatus+" ("+this.timeMs+")"),this.ajaxInsert(this.timeMs)),"running"==this.trigerStatus)var t=setTimeout(function(){Timer.timeDate[1]=new Date,Timer.timeMs=Timer.timeDate[1]-Timer.timeDate[0],debug.log(Timer.timeMs),$("time").text(Timer.timeMs.toString().convTime()),Timer.runTime()},100)},trigerStatus:"stop",down:{},initKey:32,spaceDown:function(t){t.keyCode?t.keyCode:t.which;t.keyCode==this.initKey&&("stop"==this.trigerStatus&&null==this.down[this.initKey]&&(this.trigerStatus="ready",this.ready()),"running"==this.trigerStatus&&null==this.down[this.initKey]&&(this.trigerStatus="stop",this.iddle()),this.down[this.initKey]=!0)},spaceUp:function(t){t.keyCode?t.keyCode:t.which;t.keyCode==this.initKey&&("ready"==this.trigerStatus&&(this.trigerStatus="running",this.runing()),this.down[this.initKey]=null)},ajaxInsert:function(t){window.XMLHttpRequest?xmlhttp=new XMLHttpRequest:xmlhttp=new ActiveXObject("Microsoft.XMLHTTP"),xmlhttp.open("GET","insert.php?time_ms="+t,!0),xmlhttp.send(),Timer.ajaxExtract()},ajaxExtract:function(){var t="<tr><td>"+(parseInt($("#last_times td:first").text(),10)+1)+"</td><td>"+this.timeMs.toString().convTime()+"</td></tr>";debug.log(t),$("#last_times").prepend(t)},init:function(){$(document).keydown(this.spaceDown.bind(this)),$(document).keyup(this.spaceUp.bind(this))}};Timer.init();var debug={debug:1,log:function(t){1==this.debug&&console.log(t)}};